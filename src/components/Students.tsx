  ...
  const fetchStudents = async () => {
    ...
    try {
      ...
      const transformedData = data.data.map((item: any) => ({
        ...
        class: 'N/A',
        guardianName: item.mother ? `${item.mother.user.firstName} ${item.mother.user.lastName}` : 'N/A',
  ...
  const fetchStudentById = async (id: string) => {
    ...
    try {
      ...
      const transformedStudent = {
        ...
        class: 'N/A',
        guardianName: data.mother ? `${data.mother.user.firstName} ${data.mother.user.lastName}` : 'N/A',
